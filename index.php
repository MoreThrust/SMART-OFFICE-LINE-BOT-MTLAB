                ...
                [
                    ...
                    'actions' => [
                        [
                            'type' => 'message',
                            'label' => 'ล็อคประตู',
                            'text' => 'ล็อคประตูห้องประชุม 1'
                        ],
                        [
                            'type' => 'message',
                            'label' => 'ปลดล็อคประตู',
                            'text' => 'ปลดล็อคประตูห้องประชุม 1'
                        ]
                    ]
                ],
            ]
...
}elseif($message->{"text"} == 'ล็อคประตูหลัง') {
    $messageData = [
        'type' => 'text',
        'text' => "ล็อคประตูหลังเรียบร้อยแล้ว"
    ];
...
}elseif($message->{"text"} == 'ล็อคประตูห้องประชุม 1') {
    $messageData = [
        'type' => 'text',
        'text' => "ล็อคประตูห้องประชุม 1 เรียบร้อยแล้ว"
    ];
